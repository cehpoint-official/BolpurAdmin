...
function AdminPanelContent() {
  ...
  useEffect(() => {
    ...
    // Products listener
    const unsubscribeProducts = FirebaseService.subscribeToCollection<Product>("products", (productsData) => {
    ...
    // Vendors listener
    const unsubscribeVendors = FirebaseService.subscribeToCollection<Vendor>("vendors", (vendorsData) => {
    ...
    // Orders listener
    const unsubscribeOrders = FirebaseService.subscribeToCollection<Order>("orders", (ordersData) => {
    ...
    // Users listener
    const unsubscribeUsers = FirebaseService.subscribeToCollection<User>("users", (usersData) => {
      setUsers(usersData)
    ...
    // Categories listener
    const unsubscribeCategories = FirebaseService.subscribeToCollection<Category>("categories", (categoriesData) => {
